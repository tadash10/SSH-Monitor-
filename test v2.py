        ...
        with open(log_file, 'r') as file:
            ...
            while True:
                ...
                if match:
                    ...
                    if attempts[ip_address] >= alert_threshold and current_time - last_alert_time[ip_address] >= 3600:
                        ...
                        # Retain attempts count to track ongoing attempts
                    elif attempts[ip_address] >= alert_threshold:
                        logging.info(f'Alert for IP {ip_address} already sent, skipping.')

    except FileNotFoundError:
        logging.error(f'Log file {log_file} not found.')
    except PermissionError:
        logging.error(f'Permission denied to read log file {log_file}.')
    except Exception as e:
